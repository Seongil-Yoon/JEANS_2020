...
//     let html = "";
//     $.ajax({
//         url: "/look_comment_list/" + fk_look_num_Look_look_num + "/" + parents,
//         type: "get",
...
//                 if (data.comment_id == data.parents) {
//                     //부모댓글 출력
//                     html += '<div class=\"look_comment_wrap\">';
...
//                     html = childHTML(data, html);
//                     html += '</div>';
//                 }
//                 if (result[i + 1].comment_id == result[i + 1].parents) {
//                     alert(result[i + 1].comment_id)
//                     html += '</div>'; //look_comment_wrap 닫기
//                     $(".body_root").append(html); //body 마지막에 추가
//                     html = "";
//                 }
//             }
//             //마지막 댓글 부모키 를 변수값 에 넣어서 다음 데이터 10개를 받아올 수 있게 준비함
