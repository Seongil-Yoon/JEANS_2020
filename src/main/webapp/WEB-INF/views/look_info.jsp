        ...
        <div class="body_look">
          ...
          <div class="look_img_container">
            <div class="look_img_viewport">
              ...
              <button
                type="button"
                class="look_slide_button"
                id="look_slide_button_left"
                style="left: 0"
              >
                <img
                  src="static/images/look_slide_icon_left.png"
                  class="look_slide_button_icon"
                />
              </button>
              <button
                type="button"
                class="look_slide_button"
                id="look_slide_button_right"
                style="right: 0"
              >
                <img
                  src="static/images/look_slide_icon_right.png"
                  class="look_slide_button_icon"
                />
              </button>
            </div>
          ...
          <div class="like">
            <img
              ...
              class="heart_img"
            />
            <div class="like_number">10.5K</div>
          </div>

          <div class="views">
            <img
              src="static/images/board_view_icon.svg"
              alt="search"
              height="25"
              width="25"
              class="view_icon"
                ...
                <div class="look_comment">
                    ...
                    <div class="comment_center">
                       <div class="comment_center_header">
                          <span id="js-other_people_name" class="other_people_name">${sessionScope.usernickname}</span>
                       </div>
                       <div class="comment_center_textarea">
                          ...
                          <input type="hidden" name="fk_look_num_Look_look_num"
                            value="${view.look_num}"/> <%--게시글 기본키인 게시글숫자--%>
                          <textarea class="view_comment_textarea" placeholder="댓글 내용을 입력하세요" name="comment_content"></textarea>
                       </div>
